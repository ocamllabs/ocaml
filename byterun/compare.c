...
static PER_CONTEXT struct compare_item compare_stack_init[COMPARE_STACK_INIT_SIZE];

static PER_CONTEXT struct compare_item * compare_stack;
static PER_CONTEXT struct compare_item * compare_stack_limit;

CAMLexport PER_CONTEXT int caml_compare_unordered;
